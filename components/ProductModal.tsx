                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="mt-auto">
                                    <button type="submit" className="w-full bg-rose-gold text-cocoa-brown font-bold py-3 px-6 rounded-lg hover:opacity-90 transition-opacity duration-300 shadow-md hover:shadow-lg">
